...
export default class EliminarRuta extends Component{
    constructor(props) {
        super(props);
        this.state = {
         users:[]
  ...
  render(){
      ...
      this.props.navigation.navigate('EliminarRuta2',{id:id,latInicial:latInicial,lonInicial:lonInicial,latDestino:latDestino,lonDestino:lonDestino,precio:precio});
