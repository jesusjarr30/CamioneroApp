...
export default class Historial2 extends Component{
    constructor(props) {
        super(props);
        this.state = {
         users:[]
  ...
  componentDidMount(){
    ...
    xhttp.open('GET','https://jesjarr.000webhostapp.com/camioneroViaje.php?idUsuario='+this.props.route.params.codigo,true);
    xhttp.send();
  }
  ...
  render(){
      ...
      this.props.navigation.navigate('ViajeIndividual',{id:id,latInicial:latInicial,lonInicial:lonInicial,latDestino:latDestino,lonDestino:lonDestino,precio:precio,idUsuario:this.props.route.params.codigo});
    ...
    const renderUser = ({item}) =>{
      ...
      return(
        <View>
          <Text>Historial de viajes hechos</Text>
